          ...
          >
            ...
            {onboardingStep === 1 && (
              <div style={{ display: "grid", gap: 18, gridTemplateColumns: "1fr 1fr" }}>
                <div>
                  <label style={onboardingLabelStyle()}>מצב משפחתי</label>
                  <select
                    style={inputStyle()}
                ...
                <div>
                  <label style={onboardingLabelStyle()}>מספר נפשות במשק הבית</label>
                  <input
                    style={inputStyle()}
                    type="number"
                ...
                <div>
                  <label style={onboardingLabelStyle()}>מספר ילדים</label>
                  <input
                    style={inputStyle()}
                    type="number"
                ...
                <div>
                  <label style={onboardingLabelStyle()}>האם לבן/בת הזוג יש הכנסה?</label>
                  <select
                    style={inputStyle()}
            ...
            {onboardingStep === 2 && (
              <div style={{ display: "grid", gap: 18, gridTemplateColumns: "1fr 1fr" }}>
                <div>
                  <label style={onboardingLabelStyle()}>שכר חודשי שלך</label>
                  <input
                    style={inputStyle()}
                    type="number"
                ...
                {onboardingData.hasPartnerIncome === "כן" && (
                  <div>
                    <label style={onboardingLabelStyle()}>שכר חודשי של בן/בת זוג</label>
                    <input
                      style={inputStyle()}
                      type="number"
                ...
                <div>
                  <label style={onboardingLabelStyle()}>הכנסה נוספת / קצבה</label>
                  <input
                    style={inputStyle()}
                    type="number"
                ...
                <div>
                  <label style={onboardingLabelStyle()}>באיזה תאריך נכנסת המשכורת?</label>
                  <select
                    style={inputStyle()}
            ...
            {onboardingStep === 3 && (
              <div style={{ display: "grid", gap: 18, gridTemplateColumns: "1fr 1fr" }}>
                <div>
                  <label style={onboardingLabelStyle()}>שכר דירה / משכנתא</label>
                  <input
                    style={inputStyle()}
                    type="number"
                    value={onboardingData.housingCost}
                    onChange={(e) => updateOnboardingField("housingCost", e.target.value)}
                  />
                </div>
                <div>
                  <label style={onboardingLabelStyle()}>ארנונה</label>
                  <input
                    style={inputStyle()}
                    type="number"
                    value={onboardingData.arnona}
                    onChange={(e) => updateOnboardingField("arnona", e.target.value)}
                  />
                </div>
                <div>
                  <label style={onboardingLabelStyle()}>חשמל</label>
                  <input
                    style={inputStyle()}
                    type="number"
                    value={onboardingData.electricity}
                    onChange={(e) => updateOnboardingField("electricity", e.target.value)}
                  />
                </div>
                <div>
                  <label style={onboardingLabelStyle()}>מים</label>
                  <input
                    style={inputStyle()}
                    type="number"
                    value={onboardingData.water}
                    onChange={(e) => updateOnboardingField("water", e.target.value)}
                  />
                </div>
                <div>
                  <label style={onboardingLabelStyle()}>אינטרנט + סלולר</label>
                  <input
                    style={inputStyle()}
                    type="number"
                    value={onboardingData.internetPhone}
                    onChange={(e) => updateOnboardingField("internetPhone", e.target.value)}
                  />
                </div>
                <div>
                  <label style={onboardingLabelStyle()}>רכב / תחבורה קבועה</label>
                  <input
                    style={inputStyle()}
                    type="number"
                    value={onboardingData.carTransportFixed}
                    onChange={(e) => updateOnboardingField("carTransportFixed", e.target.value)}
                  />
                </div>
                <div>
                  <label style={onboardingLabelStyle()}>הלוואות</label>
                  <input
                    style={inputStyle()}
                    type="number"
                    value={onboardingData.loans}
                    onChange={(e) => updateOnboardingField("loans", e.target.value)}
                  />
                </div>
                <div>
                  <label style={onboardingLabelStyle()}>חינוך קבוע</label>
                  <input
                    style={inputStyle()}
                    type="number"
                    value={onboardingData.educationFixed}
                    onChange={(e) => updateOnboardingField("educationFixed", e.target.value)}
                  />
                </div>
                <div>
                  <label style={onboardingLabelStyle()}>ביטוחים</label>
                  <input
                    style={inputStyle()}
                    type="number"
                    value={onboardingData.insurance}
                    onChange={(e) => updateOnboardingField("insurance", e.target.value)}
                  />
                </div>

                <div style={{ gridColumn: "1 / -1", marginTop: 4 }}>
                  <p style={helperTextStyle()}>
                    הזנת ההוצאות הקבועות תאפשר למערכת ליצור עבורך תחזית חודשית
                    אוטומטית ולהגדיר בסיס נכון לכל חודש עתידי.
                  </p>
                </div>
              </div>
            )}
            ...
            {onboardingStep === 4 && (
              <div style={{ display: "grid", gap: 16, gridTemplateColumns: "repeat(3, 1fr)" }}>
                ...
                <div style={{ gridColumn: "1 / -1", marginTop: 4 }}>
                  <p style={helperTextStyle()}>
                    אלו תקציבי פתיחה חכמים לפי גודל משק הבית שלך. אפשר לעדכן כל
                    סכום ידנית כבר עכשיו או אחר כך מתוך אזור הדוחות.
                  </p>
                </div>
              </div>
            )}
                  ...
                  <div style={{ display: "grid", gap: 10 }}>
                    {summaryTemplatesPreview.length === 0 ? (
                      <div style={{ color: "#64748b" }}>
                        לא הוגדרו עדיין הכנסות/הוצאות קבועות.
                      </div>
                    ) : (
          ...
          >
            ...
            >
              {loggedInUser ? (
                ...
                <>
                  <input
                    style={{ ...inputStyle(), width: 220, border: "1px solid #cbd5e1" }}
                    placeholder="אימייל"
                    value={userEmail}
            ...
            <div style={cardStyle()}>
              ...
              >
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  <select
                    style={{ ...inputStyle(), width: 170, border: "1px solid #cbd5e1" }}
                    value={filterType}
            ...
            <div style={cardStyle()}>
              ...
              <div style={{ display: "grid", gap: 14 }}>
                <div>
                  ...
                  <select
                    style={{ ...inputStyle(), border: "1px solid #cbd5e1" }}
                    value={type}
